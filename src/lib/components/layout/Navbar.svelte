...
<header class="pointer-events-none fixed inset-x-0 top-0 z-50">
  <div class="pointer-events-none absolute inset-x-0 top-0 h-24 bg-gradient-to-b from-ink-950/80 via-ink-950/40 to-transparent"></div>

  <div class="pointer-events-auto relative mx-auto flex max-w-[1400px] items-center justify-between px-6 pt-5">
    <a href="/" class="group flex items-center gap-3">
      <span class="snake-border relative inline-flex h-10 items-center gap-2 overflow-hidden rounded-full bg-white/[0.04] px-3.5 py-2 backdrop-blur-xl">
        <img src="/newshields.svg" alt="NewShields" class="h-6   w-auto" />
      </span>
    </a>
    ...
    <div class="flex items-center gap-2">
      <a
        ...
        class="snake-border group inline-flex items-center gap-2 rounded-full bg-white/[0.04] px-4 py-2.5 text-xs font-medium text-white/85 backdrop-blur-xl transition hover:bg-white/10"
      >
